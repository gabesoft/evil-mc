...
** TODO Insertion of characters takes a while to display the last char for fake cursors
** DONE Fix pattern 
CLOSED: [2015-09-28 Mon 21:44]
*** when selecting a quote or square bracket creating cursors errors out with invalid pattern
** Rename emc to evil-mc
*** prefixes
*** file names
*** project name
*** documentation
