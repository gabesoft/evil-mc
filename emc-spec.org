...
*** TODO create all cursors matching the word/WORD/symbol at cursor
*** TODO next should wrap
*** DONE skip
CLOSED: [2015-08-29 Sat 17:56]
*** DONE undo a cursor
CLOSED: [2015-08-29 Sat 17:56]
*** TODO create a cursor at point even if it doesn't match the current pattern
*** TODO delete the cursor at point
*** TODO navigate through cursors
*** TODO create/delete at point, as well as navigating through cursors will require a way to freeze the cursors temporarily
...
** TODO Implement redo for fake cursors
** TODO Implement paste/copy from/to registers
** TODO Determine why some keys are lost
