...
(defvar emc-known-commands
  '(
    ...
    (evil-find-char . ((:default . emc-execute-find-char)))
    (evil-find-char-backward . ((:default . emc-execute-find-char)))
    (evil-find-char-to . ((:default . emc-execute-find-char)))
    (evil-find-char-to-backward . ((:default . emc-execute-find-char)))
    (evil-snipe-F . ((:default . emc-execute-evil-snipe)))
    (evil-snipe-S . ((:default . emc-execute-evil-snipe)))
    (evil-snipe-T . ((:default . emc-execute-evil-snipe)))
    (evil-snipe-f . ((:default . emc-execute-evil-snipe)))
    (evil-snipe-s . ((:default . emc-execute-evil-snipe)))
    (evil-snipe-t . ((:default . emc-execute-evil-snipe)))
